...
public class Data {
    ...
    public void addToWordIndx(String word, int cnt, String doc, double tf){
    ...
    public static void main(String[] args) {
        ...
        while(c.hasNext()){
            ...
            System.out.println("OLD : "+ sc );
            sc = sc * (double)10;
            System.out.println("NEW :"+sc);
            BasicDBObject setNewFieldQuery = new BasicDBObject().append("$set", new BasicDBObject().append("score", sc));
